...
int main(int argc, char **argv)
{
  ...
  node->declare_parameter("save_directory", "/home/cxx/Fast-LIO2_SC-SLAM/output/"); // pose assignment every k m move 
  ...
  mapVizFilterSize = node->get_parameter("mapviz_filter_size").get_parameter_value().get<double>();
    ...
    // auto subSCContext = node->create_subscription<sensor_msgs::msg::NavSatFix>("", 100, gpsHandler);
