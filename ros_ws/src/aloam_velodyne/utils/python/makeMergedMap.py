...
bone_table = np.load('/home/cxx/Fast-LIO2_SC-SLAM/ros_ws/src/aloam_velodyne/utils/python/bone_table.npy')
...
data_dir = "/home/cxx/Fast-LIO2_SC-SLAM/output/" # should end with / 
scan_idx_range_to_stack = [0, 240] # if you want a whole map, use [0, len(scan_files)]
node_skip = 1
